...
open OUT, ">sectionout.dat" or die "Cant open sectionout.dat\n$!\n";
print OUT "line_no	pid	file	status	typed	genus	species	author	year	section	secinfo	subsection	subgenus	series\n";
